    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('portfolio') }}"><button class="btn btn-primary" style="float:right;">Add</button></a><br><br>
                                ...
                                @foreach ($image as $key => $images)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('editportfolio', $images->id) }}"
                                                class="btn btn-info btn-sm waves-effect">
                                                <i class="fa fa-edit" style="font-size:20px">
                                                </i>
                                            </a>
                                            <form method="POST" action="{{ route('delete_portfolio', $images->id) }}">
                                                @csrf
                                                @method('delete')
