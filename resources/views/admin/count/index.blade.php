    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('addcount') }}"><button class="btn btn-primary" style="float:right;">Add</button></a><br><br>
                        ...
                        <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @foreach ($image as $key => $images)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $images->numbers }}</td>
                                        <td>{{ $images->title }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('editcount', $images->id) }}"
                                                class="btn btn-info btn-sm waves-effect">
                                                <i class="fa fa-edit" style="font-size:20px">
                                                </i>
                                            </a>
                                            <form method="POST" action="{{ route('deletecount', $images->id) }}">
                                                @csrf 
                                                @method('delete')
