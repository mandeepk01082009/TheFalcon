  ...
  <div>
    <div class="brand-logo d-flex align-items-center justify-content-between">
      <a href="{{ route('home') }}" class="text-nowrap logo-img">
        <img src="{{ asset('web/assets/img/logo/logo.jpg') }}" width="100" alt="" />
      </a>
    ...
    <nav class="sidebar-nav scroll-sidebar mt-3" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="{{ route('count') }}" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="{{ route('portfolios') }}" aria-expanded="false">
            <span>
              <i class="ti ti-article"></i>
            </span>
